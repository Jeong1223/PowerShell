param (
    ...
    [string]$Destination,  # Copy the Files to this Location

    [Parameter(Mandatory=$true)]
    [string]$Versions,  # How many of the last Backups you want to keep

    [Parameter(Mandatory=$true)]
    [Object[]]$BackupDirs  # What Folders you want to backup   
)

$StagingPath="C:\temp\Staging"
$ExcludeDirs="C:\Source1\dontbackthisup1","C:\Source2\dontbackthisUp2"  #This list of Directories will not be copied
